...
const UpdatePassword = () => {
  ...
  const handleUpdatePassword =async() => {
    try {
      ...
      const response = await axios.put("http://localhost:8000/user/update/password", updatePasswordInput, {withCredentials: true, headers : {"Content-Type" : "application/json"}});
